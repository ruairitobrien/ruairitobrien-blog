...
Does practicing TDD make you more productive? Does it improve code quality? Just measuring productivity or code quality is difficult enough. 

In this post we will look at some of the discussion going on around TDD in the industry and at some of the efforts made to evaluate TDD in a scientific way. We probably won't positively answer the question 'Does TDD Work?' but no harm in trying. 

## Opinions in Industry
[Kent Beck](https://www.facebook.com/kentlbeck)  is  [credited with having developed or 'rediscovered'](https://en.wikipedia.org/wiki/Test-driven_development) TDD somewhere around 1999.  Since then there have been many proponents of TDD and a [multitude of books](https://www.amazon.com/s/ref=nb_sb_ss_i_1_14?url=search-alias%3Dstripbooks&field-keywords=test+driven+development&sprefix=test+driven+de%2Cstripbooks%2C218&crid=2ADA7QMBPC5FP) on the subject. There is certainly a vocal group in the industry that claim TDD is critically important to writing good software.

[David Heinemeier Hansson](http://david.heinemeierhansson.com/) (who's name is often abbreviated to DHH) is the creator of [Ruby on Rails](http://rubyonrails.org/) who appears to have a strong opinion against TDD as mentioned in his blog post [TDD is dead. Long live testing](http://david.heinemeierhansson.com/2014/tdd-is-dead-long-live-testing.html). An interesting thing with that post is the point of view is taken that TDD has somehow won in the industry and is causing harm. DHH is certainly not alone in this outlook (try searching for 'Against TDD').

In my personal experience however, TDD is not generally accepted as a necessary process in software development and is rarely mandated. There is a lot of debate and while being a practitioner of TDD is not looked down upon, it is not generally seen as being important or necessarily correct. This differs between software teams of course but in general this is my experience. In so many teams I have worked with in various companies and in standups I have attended I hear developers say things like, 'I am done but just need to add tests now before I open a pull request'. In  conversations like this I have never heard anyone suggest the TDD process should have been used. It is left to the individual developers to decide that for the most part.

[Uncle Bob Martin](https://en.wikipedia.org/wiki/Robert_Cecil_Martin) is a strong proponent of TDD and attempts to refute DHH's points in his post [Monogamous TDD](https://8thlight.com/blog/uncle-bob/2014/04/25/MonogamousTDD.html) and also in [When TDD doesn’t work](https://8thlight.com/blog/uncle-bob/2014/04/30/When-tdd-does-not-work.html).
...
Testing is a discipline that needs to be learned to see the benefits of it. That one is my own observation that is difficult to back up with data except that which we looked at in surveys conducted in some studies.

Will we ever know for sure if TDD really works or not? I don't know. 

## Personal Thoughts On All This
I spend a lot of time urging other developers to do TDD or at least to try it out. Usually people will give it a go but have difficulty sticking with it. I try to explain it is something you learn over time and when you get good at it, it’s great!

It occurred to me fairly often though that I might be wrong. What if I am trying to get people to invest time in something that isn’t that great. What proof is there that TDD even works? Just because it seems to work for me, why should it work for anyone else? Maybe I have been brainwashed by all the content I have consumed on the subject. 
...
I personally do think varied approaches to TDD are OK. The definition of TDD shouldn't be like some ancient text that should be taken absolutely literally and those of us that believe in it must treat those that don't with derision. 

To me one of the biggest advantages (maybe the most under-appreciated advantage) to TDD is the design that it encourages. A complaint I always hear is that too many unit tests lead to code that's difficult to maintain and change. That's just a common pitfall in the learning process. Once you add TDD to your arsenal of software development techniques and learn it well, it should really help in achieving good software design. If good, clean, well-designed software is your goal, I believe TDD is a process that will help achieve that better than anything else I have seen so far.
...
I would love to see something like a test-only approach. Perhaps a language where you only write tests and configurations and somehow end up with really efficient production code that you don't have to read. Maybe an interesting side project I might work on one day. For now, after everything I have read and experienced, TDD is the best I have and I will keep using it and encouraging others to do the same.
